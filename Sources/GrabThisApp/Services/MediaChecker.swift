...
//  GrabThisApp
//
//  Verifies MediaRemote entitlements work before using the adapter.
//  Based on boring.notch implementation.
//
...
final class MediaChecker: Sendable {
    ...
    /// Returns true if MediaRemote is deprecated/non-functional, false if it works
